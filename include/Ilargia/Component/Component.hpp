...
namespace ilg
{
	...
	public:
		...
		m::i32 getInstanceIndex() const;
		m::u64 getInstanceTypeId() const;
		m::String getInstanceName() const;
	...
	protected:
		m::u64 m_instanceTypeId;
		m::i32 m_instanceIndex;
		m::String m_instanceName;
	};
}
